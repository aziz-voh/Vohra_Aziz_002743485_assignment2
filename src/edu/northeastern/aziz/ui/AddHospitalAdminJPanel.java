...
public class AddHospitalAdminJPanel extends javax.swing.JPanel {
    ...
    HospitalAdminDirectory hospAdminDir;
    
    public AddHospitalAdminJPanel(CityDirectory cityDir, CommunityDirectory commDir, HouseDirectory houseDir, PatientDirectory patientDir, DoctorDirectory docDir, HospitalDirectory hospDir, HospitalAdminDirectory hospAdminDir) {
        initComponents();
        ...
        this.docDir = docDir;
        this.hospAdminDir = hospAdminDir;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Create Hospital Admin");
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        HospitalAdmin hos = hospAdminDir.addNewHospAdmin();

        hos.setName(name);
        hos.setAge(Short.parseShort(age));
        hos.setEmail(email);
        hos.setGender(gender);
        hos.setPhoneNo(Long.parseLong(phoneNo));
        hos.setUsername(userName);
        hos.setPassword(pass);
        ...
        JOptionPane.showMessageDialog(this, "New Hospital Admin record added");
